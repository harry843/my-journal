...
<section class="flex flex-col items-center justify-center">
	...
	<header id="main-header" class="flex flex-col gap-y-3 py-6 items-start justify-start border border-t-slate-200 border-b-slate-200 dark:border-t-slate-600 dark:border-b-slate-600 border-r-0 border-l-0 w-full">
	...
	<div class="flex items-center justify-center w-full" style="height: calc(100vh - {headerHeight}px);">
		<Loading />
	</div>
	{:else}
	<div class="flex items-center justify-center w-full" style="height: calc(100vh - {headerHeight}px);">
